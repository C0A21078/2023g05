...
<body>
  ...
  <div style="display: flex; align-items: center;">
    ...
    <span style="font-size: 45px; font-weight: bold;">ドラゴンクエストV 天空の花嫁</span>
  </div>
...
<%
  try {
    ...
    // ステートメントの作成とSQL文の実行
    String sql = "SELECT star_rating, COUNT(*) as count FROM app_dorakuev_review GROUP BY star_rating";
...
<%
  try {
    ...
    // ステートメントの作成とSQL文の実行
    String sql = "SELECT * FROM app_dorakuev_review";
    Statement stmt = con.createStatement();
    ResultSet rs = stmt.executeQuery(sql);
