...
<body>
  ...
  <div style="display: flex; align-items: center;">
    ...
    <span style="font-size: 45px; font-weight: bold;">モンスターストライク</span>
  </div>
    ...
    <div class="popup-content">
      ...
      <div id="collapse-content">
        ...
        <p>
          ...
          Android5.0以上
          (Android5.0未満は動作不可)
          ※必須環境を満たす端末であっても、端末の性能や仕様、端末固有のアプリ利用状況などによって正常に動作しない場合があります
        </p>
        <p>
          詳しくは以下URLをご確認ください。
        ...
        <p>
          +++【個人情報の取り扱いについて】+++
          モンスターストライクは友人とよりつながりやすくなる方法として電話帳からのSMS招待が可能になっております。
          電話番号が招待以外の目的で利用されることはありませんのでご安心ください。
        </p>
        <p>
...
<%
  try {
    ...
    // ステートメントの作成とSQL文の実行
    String sql = "SELECT star_rating, COUNT(*) as count FROM app_monsuto_review GROUP BY star_rating";
...
<%
  try {
    ...
    // ステートメントの作成とSQL文の実行
    String sql = "SELECT * FROM app_monsuto_review";
    Statement stmt = con.createStatement();
    ResultSet rs = stmt.executeQuery(sql);
