...
<body>
  ...
  <div style="display: flex; align-items: center;">
    ...
    <span style="font-size: 45px; font-weight: bold;">ドラゴンクエストウォーク</span>
  </div>
  ...
  <div class="popup-overlay" id="popup-overlay">
    <div class="popup-content">
      ...
      <div id="collapse-content">
        ...
        <p>
          【動作環境】OS：Android：4.4以上、メモリ(RAM)2GB以上の端末
        </p>
        <p>
...
<%
  try {
    ...
    // ステートメントの作成とSQL文の実行
    String sql = "SELECT star_rating, COUNT(*) as count FROM app_dorakuewalk_review GROUP BY star_rating";
...
<%
  try {
    ...
    // ステートメントの作成とSQL文の実行
    String sql = "SELECT * FROM app_dorakuewalk_review";
    Statement stmt = con.createStatement();
    ResultSet rs = stmt.executeQuery(sql);
